...
public:
  ...
  [[nodiscard]] inline const BigInteger &GetCreditLimit() const {
    return credit_limit_;
  }
  [[nodiscard]] inline const BigInteger &GetBankFee() const {
    return bank_fee_;
  }
  [[nodiscard]] inline int GetDepositPercent() const {
    return deposit_percent_;
  }
